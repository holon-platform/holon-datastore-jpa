...
@ContextConfiguration(classes = TestEnableJpaTrace.Config.class)
public class TestEnableJpaTrace extends AbstractEnableJpaTest {

	@PropertySource("test_trace.properties")
	@EnableDataSource
