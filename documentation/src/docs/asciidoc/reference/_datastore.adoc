...
[source, java]
----
include::{examplesdir}/com/holonplatform/datastore/jdbc/examples/ExampleJpaDatastoreLock.java[tag=lockcommodity,indent=0]
----
...
[source, java]
----
include::{examplesdir}/com/holonplatform/datastore/jdbc/examples/ExampleJpaDatastoreLock.java[tag=execution,indent=0]
----
...
The JPA `Datastore` API supports `DatastoreCommodityFactory` automatic registration using the link:{apidir}/com/holonplatform/datastore/jpa/config/JpaDatastoreCommodityFactory.html[JpaDatastoreCommodityFactory^] type using a _Java service extensions_ based registration method.
