...
TIP: See the core link:../../holon-core/core.html#Datastore[Datastore] documentation for more informations about *DataTarget*s and *Path*s, and about the use of extension hooks such as *DataTargetResolver* for target names resolution.
...
See the link:../../holon-core/core.html#subquery[Sub query documentation] for further information and code examples.
...
See the link:../../holon-core/core.html#joins[Alias and Joins documentation] for further information and code examples.
