...
@ContextConfiguration(classes = TestJpaDatastoreHibernate.Config.class)
@DirtiesContext
public class TestJpaDatastoreHibernate extends AbstractJpaDatastoreTest {
	...
	protected static class Config {
		...
		public DataSource dataSource() {
			return new EmbeddedDatabaseBuilder().setType(EmbeddedDatabaseType.H2).setName("testjpa1hbn")
