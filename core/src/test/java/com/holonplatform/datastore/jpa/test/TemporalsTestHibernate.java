...
@ContextConfiguration(classes = TemporalsTestHibernate.Config.class)
@DirtiesContext
public class TemporalsTestHibernate extends AbstractTemporalsTest {
	...
	protected static class Config {
		...
		public DataSource dataSource() {
			return new EmbeddedDatabaseBuilder().setType(EmbeddedDatabaseType.H2).setName("testjpat1hbn")
