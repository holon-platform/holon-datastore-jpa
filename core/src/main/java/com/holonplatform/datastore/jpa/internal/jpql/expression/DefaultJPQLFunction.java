...
/**
 * Default {@link JPQLFunction} implementation.
 *
 * @since 5.0.0
 */
public class DefaultJPQLFunction implements JPQLFunction {
	 ...
	 */
	public DefaultJPQLFunction(String name, boolean parenthesesIfNoArguments) {
		super();
	...
	public String toString() {
		return "DefaultJPQLFunction [name=" + name + ", parenthesesIfNoArguments=" + parenthesesIfNoArguments + "]";
	}
