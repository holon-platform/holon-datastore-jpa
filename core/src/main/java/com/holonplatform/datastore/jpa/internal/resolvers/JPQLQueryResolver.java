...
/**
 * {@link JPQLQuery} expression resolver
 *
 * @since 5.1.0
 */
@SuppressWarnings("rawtypes")
@Priority(Integer.MAX_VALUE)
public enum JPQLQueryResolver implements JPQLContextExpressionResolver<JPQLQuery, JPQLExpression> {
	 ...
	 */
	@Override
	public Class<? extends JPQLQuery> getExpressionType() {
	 ...
	 */
	@Override
	public Optional<JPQLExpression> resolve(JPQLQuery expression, JPQLResolutionContext context)
			throws InvalidExpressionException {

		// validate
		expression.validate();

		return Optional.of(JPQLExpression.create(expression.getJPQL()));
	}
