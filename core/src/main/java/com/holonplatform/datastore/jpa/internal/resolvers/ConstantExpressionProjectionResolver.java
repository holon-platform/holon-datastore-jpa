...
public enum ConstantExpressionProjectionResolver
	...
	public Optional<ProjectionContext> resolve(ConstantExpressionProjection expression, ResolutionContext context)
		...
		DefaultProjectionContext ctx = new DefaultProjectionContext(jpaContext,
				TypeUtils.box(expression.getType()));
		ctx.addSelection(serializeLiteralValue(expression.getValue()), false);
