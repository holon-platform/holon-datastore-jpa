...
/**
 * Default {@link JPQLLiteral} implementation.
 *
 * @param <T> Value type
 *
 * @since 5.0.0
 */
public class DefaultJPQLLiteral<T> implements JPQLLiteral<T> {
	 ...
	 */
	public DefaultJPQLLiteral(T value) {
		this(value, null);
	}
	 ...
	 */
	public DefaultJPQLLiteral(T value, TemporalType temporalType) {
		super();
		this.value = value;
	...
	public String toString() {
		return "DefaultLiteralValue [value=" + value + ", temporalType=" + temporalType + "]";
	}
