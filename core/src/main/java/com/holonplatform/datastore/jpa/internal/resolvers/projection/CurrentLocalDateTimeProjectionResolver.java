...
public enum CurrentLocalDateTimeProjectionResolver
		implements JPQLContextExpressionResolver<CurrentLocalDateTime, JPQLProjection> {
	 ...
	 */
	@Override
	public Class<? extends CurrentLocalDateTime> getExpressionType() {
		return CurrentLocalDateTime.class;
	}
	...
	@Override
	public Optional<JPQLProjection> resolve(CurrentLocalDateTime expression, JPQLResolutionContext context)
