...
public class DefaultOperationStructure implements OperationStructure {
	...
	/*
	 * (non-Javadoc)
	 * @see com.holonplatform.datastore.jpa.internal.expressions.OperationStructure#getOperationType()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.holonplatform.datastore.jpa.internal.expressions.OperationStructure#getTarget()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.holonplatform.datastore.jpa.internal.expressions.OperationStructure#getFilter()
	 */
	@Override
	...
	public static class DefaultBuilder implements Builder {
		...
		/*
		 * (non-Javadoc)
		 * @see com.holonplatform.datastore.jpa.internal.expressions.OperationStructure.Builder#build()
		 */
		@Override
