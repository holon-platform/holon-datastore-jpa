...
/**
 * A JPA {@link AttributeConverter} to enable {@link LocalDate} data type for entity attributes.
 * <p>
...
public class LocalDateToDateAttributeConverter implements AttributeConverter<LocalDate, Date> {
	...
	public Date convertToDatabaseColumn(LocalDate attribute) {
		return ConversionUtils.fromLocalDate(attribute);
	}
	...
	public LocalDate convertToEntityAttribute(Date dbData) {
		return ConversionUtils.toLocalDate(dbData);
	}
