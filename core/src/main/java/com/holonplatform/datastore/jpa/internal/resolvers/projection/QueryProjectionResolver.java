...
public enum QueryProjectionResolver implements JPQLContextExpressionResolver<QueryProjection, JPQLProjection> {
	 ...
	 */
	@Override
	public Optional<JPQLProjection> resolve(QueryProjection expression, JPQLResolutionContext context)
		...
		return context.resolve(expression, QueryProjection.class).flatMap(resolved -> {
			...
			return context.resolve(resolved, JPQLProjection.class);
		});
