...
public enum NullExpressionResolver implements JPQLContextExpressionResolver<NullExpression, JPQLExpression> {
	 ...
	 */
	@Override
	public Optional<JPQLExpression> resolve(NullExpression expression, JPQLResolutionContext context)
